...
sourcesIndex["backup_cli"] = {"name":"","dirs":[{"name":"backup_types","dirs":[{"name":"epoch_ending","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"state_snapshot","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"transaction","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]}],"files":["mod.rs"]},{"name":"coordinator","files":["mod.rs"]},{"name":"metadata","files":["cache.rs","mod.rs","view.rs"]},{"name":"storage","dirs":[{"name":"command_adapter","files":["config.rs","mod.rs"]},{"name":"local_fs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","files":["backup_service_client.rs","mod.rs","read_record_bytes.rs","storage_ext.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["bytecode_verifier"] = {"name":"","dirs":[{"name":"locals_safety","files":["abstract_state.rs","mod.rs"]},{"name":"reference_safety","files":["abstract_state.rs","mod.rs"]}],"files":["absint.rs","acquires_list_verifier.rs","binary_views.rs","check_duplication.rs","code_unit_verifier.rs","constants.rs","control_flow.rs","control_flow_graph.rs","dependencies.rs","instantiation_loops.rs","instruction_consistency.rs","lib.rs","resources.rs","signature.rs","stack_usage_verifier.rs","struct_defs.rs","type_safety.rs","unused_entries.rs","verifier.rs"]};
...
sourcesIndex["executor"] = {"name":"","dirs":[{"name":"speculation_cache","files":["mod.rs"]}],"files":["db_bootstrapper.rs","lib.rs","metrics.rs","types.rs"]};
...
sourcesIndex["libra_fuzzer"] = {"name":"","dirs":[{"name":"fuzz_targets","files":["compiled_module.rs","consensus_proposal.rs","inbound_rpc_protocol.rs","inner_signed_transaction.rs","json_rpc_service.rs","language_transaction_execution.rs","mempool.rs","network_noise_initiator.rs","network_noise_responder.rs","state_sync_msg.rs","storage_schema_decode.rs","vm_value.rs"]}],"files":["commands.rs","fuzz_targets.rs","lib.rs"]};
...
sourcesIndex["libra_management"] = {"name":"","files":["config.rs","error.rs","lib.rs","secure_backend.rs","storage.rs","validator_config.rs"]};
...
sourcesIndex["libra_operational_tool"] = {"name":"","files":["account.rs","command.rs","governance.rs","json_rpc.rs","keys.rs","lib.rs","operator_key.rs","validate_transaction.rs","validator_config.rs","validator_set.rs","waypoint.rs"]};
...
sourcesIndex["libra_secure_storage"] = {"name":"","files":["cached_storage.rs","crypto_kv_storage.rs","crypto_storage.rs","error.rs","github.rs","in_memory.rs","kv_storage.rs","lib.rs","namespaced_storage.rs","on_disk.rs","policy.rs","storage.rs","value.rs","vault.rs"]};
...
sourcesIndex["move_vm_runtime"] = {"name":"","files":["data_cache.rs","data_operations.rs","interpreter.rs","lib.rs","loader.rs","move_vm.rs","native_functions.rs","runtime.rs","session.rs","tracing.rs"]};
...
sourcesIndex["safety_rules"] = {"name":"","files":["consensus_state.rs","counters.rs","error.rs","lib.rs","local_client.rs","logging.rs","persistent_safety_storage.rs","process.rs","process_client_wrapper.rs","remote_service.rs","safety_rules.rs","safety_rules_manager.rs","serializer.rs","spawned_process.rs","t_safety_rules.rs","test_utils.rs","thread.rs"]};
...
sourcesIndex["state_synchronizer"] = {"name":"","dirs":[{"name":"tests","files":["fuzzing.rs","helpers.rs","mock_storage.rs","mod.rs"]}],"files":["chunk_request.rs","chunk_response.rs","coordinator.rs","counters.rs","executor_proxy.rs","lib.rs","network.rs","peer_manager.rs","synchronizer.rs"]};
...
sourcesIndex["transaction_builder_generator"] = {"name":"","files":["common.rs","cpp.rs","java.rs","lib.rs","python3.rs","rust.rs"]};
...
sourcesIndex["vm"] = {"name":"","dirs":[{"name":"proptest_types","files":["constants.rs","functions.rs","signature.rs","types.rs"]}],"files":["access.rs","check_bounds.rs","constant.rs","deserializer.rs","errors.rs","file_format.rs","file_format_common.rs","internals.rs","lib.rs","proptest_types.rs","serializer.rs","views.rs"]};
