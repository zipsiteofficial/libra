...
sourcesIndex["backup_cli"] = {"name":"","dirs":[{"name":"backup_types","dirs":[{"name":"epoch_ending","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"state_snapshot","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"transaction","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]}],"files":["mod.rs"]},{"name":"coordinators","files":["backup.rs","mod.rs","restore.rs"]},{"name":"metadata","files":["cache.rs","mod.rs","view.rs"]},{"name":"storage","dirs":[{"name":"command_adapter","files":["command.rs","config.rs","mod.rs"]},{"name":"local_fs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","files":["backup_service_client.rs","mod.rs","read_record_bytes.rs","storage_ext.rs"]}],"files":["lib.rs"]};
