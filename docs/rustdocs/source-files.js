...
sourcesIndex["backup_cli"] = {"name":"","dirs":[{"name":"backup_types","dirs":[{"name":"epoch_ending","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"state_snapshot","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"transaction","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]}],"files":["mod.rs"]},{"name":"coordinators","files":["backup.rs","mod.rs","restore.rs"]},{"name":"metadata","files":["cache.rs","mod.rs","view.rs"]},{"name":"metrics","files":["mod.rs","restore.rs"]},{"name":"storage","dirs":[{"name":"command_adapter","files":["command.rs","config.rs","mod.rs"]},{"name":"local_fs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","files":["backup_service_client.rs","mod.rs","read_record_bytes.rs","storage_ext.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["libra_operational_tool"] = {"name":"","files":["account.rs","account_resource.rs","command.rs","governance.rs","json_rpc.rs","keys.rs","lib.rs","owner.rs","test_helper.rs","validate_transaction.rs","validator_config.rs","validator_set.rs","waypoint.rs"]};
