...
sourcesIndex["backup_cli"] = {"name":"","dirs":[{"name":"backup_types","dirs":[{"name":"epoch_ending","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"state_snapshot","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"transaction","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]}],"files":["mod.rs"]},{"name":"coordinators","files":["backup.rs","mod.rs","restore.rs","verify.rs"]},{"name":"metadata","files":["cache.rs","mod.rs","view.rs"]},{"name":"metrics","files":["mod.rs","restore.rs","verify.rs"]},{"name":"storage","dirs":[{"name":"command_adapter","files":["command.rs","config.rs","mod.rs"]},{"name":"local_fs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","files":["backup_service_client.rs","mod.rs","read_record_bytes.rs","storage_ext.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["language_e2e_tests"] = {"name":"","dirs":[{"name":"account_universe","files":["bad_transaction.rs","create_account.rs","peer_to_peer.rs","rotate_key.rs","universe.rs"]},{"name":"execution_strategies","files":["basic_strategy.rs","guided_strategy.rs","mod.rs","multi_strategy.rs","random_strategy.rs","types.rs"]}],"files":["account.rs","account_universe.rs","common_transactions.rs","compile.rs","currencies.rs","data_store.rs","executor.rs","gas_costs.rs","keygen.rs","lib.rs","proptest_types.rs"]};
